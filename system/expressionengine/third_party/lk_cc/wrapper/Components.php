...
class Campaign extends CCObject{
    ...
    public static function createStruct($parsedReturn){
        ...
        $campaign['permissionReminderText'] = (string) $parsedReturn->content->Campaign->PermissionReminderText;
...
class CTCTException extends Exception{
    ...
    public function generateError($msgPrefix=null){
        ...
        // RYAN :  changed code to return the value instead of outputting it
        return $msgPrefix.' '.$this->getMessage();
    }
