...
class CTCTDataStore {
	...
	function lookupUser($username) {
		try {
			...
			// Uncomment this line to show error messages
...
class CTCTRequest {
	...
	/*
	 * @param string $authType - 'basic' or 'oauth' authentication @param string
	 * $apiKey - valid apiKey @param string $username - constant contact
	 * username @param string $authParam - password for Basic authentication,
	 * consumerSecret for OAuth authentication
	 */
